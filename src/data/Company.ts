...
<div class="relative z-10 px-margin-mobile sm:px-margin-tablet md:px-margin-desktop max-w-container-max mx-auto text-center">
...
<section class="bg-surface-container-low py-16 md:py-section-gap px-margin-mobile sm:px-margin-tablet md:px-margin-desktop">
  <div class="max-w-container-max mx-auto">
    <div class="text-center mb-16">
      ...
      <h2 class="font-headline-xl text-[22px] sm:text-headline-xl">Our Global Impact</h2>
    </div>
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
      <div class="text-center">
        <div class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-display-lg text-primary mb-2"><span class="count-up" data-target="10" data-suffix="+">0</span></div>
        <div class="font-label-md text-on-surface-variant uppercase tracking-widest">Years in Market</div>
      </div>
      <div class="text-center">
        <div class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-display-lg text-primary mb-2"><span class="count-up" data-target="250" data-suffix="+">0</span></div>
        <div class="font-label-md text-on-surface-variant uppercase tracking-widest">Expert Engineers</div>
      </div>
      <div class="text-center">
        <div class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-display-lg text-primary mb-2"><span class="count-up" data-target="500" data-suffix="+">0</span></div>
        <div class="font-label-md text-on-surface-variant uppercase tracking-widest">Projects Delivered</div>
      </div>
      <div class="text-center">
        <div class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-display-lg text-primary mb-2"><span class="count-up" data-target="99" data-suffix="%">0</span></div>
...
<!-- Leadership Section -->
<section class="bg-inverse-surface text-inverse-on-surface py-16 md:py-section-gap px-margin-mobile sm:px-margin-tablet md:px-margin-desktop relative overflow-hidden" id="elite-section">
...
<div class="max-w-xl">
<h2 class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-headline-xl mb-6">Led by Elite Engineers</h2>
...
<h4 class="font-headline-lg text-[20px] sm:text-headline-lg mb-1">Jawad Khan</h4>
...
<h4 class="font-headline-lg text-[20px] sm:text-headline-lg mb-1">Ali Hasnain</h4>
...
<h4 class="font-headline-lg text-[20px] sm:text-headline-lg mb-1">Uzair Rahim</h4>
...
<h4 class="font-headline-lg text-[20px] sm:text-headline-lg mb-1">Talha Rafi</h4>
...
<section class="px-margin-mobile sm:px-margin-tablet md:px-margin-desktop py-16 md:py-section-gap max-w-container-max mx-auto">
...
<h2 class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-headline-xl mb-8">Uncompromising Compliance Architecture.</h2>
...
<div class="md:w-1/2 grid grid-cols-2 gap-4 p-6 md:p-8 bg-surface-container rounded-3xl">
...
<section class="mb-12 md:mb-section-gap px-margin-mobile sm:px-margin-tablet md:px-margin-desktop max-w-container-max mx-auto">
<div class="bg-primary-container text-on-primary-container p-8 md:p-12 lg:p-24 rounded-3xl relative overflow-hidden">
<div class="absolute top-0 right-0 w-1/2 h-full opacity-20 pointer-events-none">

</div>
<div class="relative z-10 max-w-2xl">
<h2 class="font-display-lg text-[28px] sm:text-display-lg-mobile md:text-display-lg mb-8">Ready to engineer your edge?</h2>
...
<a class="bg-on-primary-container text-primary-container px-8 py-3 md:py-4 rounded-xl font-headline-lg flex items-center justify-center hover:opacity-90 transition-all" href="/contact">Start Scoping</a>
<a class="border border-on-primary-container/30 text-on-primary-container px-8 py-3 md:py-4 rounded-xl font-headline-lg flex items-center justify-center hover:bg-on-primary-container/10 transition-all" href="/case-studies">Download Thesis</a>
</div>
</div>
</div>
</section>
