...
export const heroTitle: ReactNode[] = [
  'We Build, Market & ',
  <span key="highlight" className="bg-gradient-to-r from-primary via-secondary to-primary bg-clip-text text-transparent">Scale Your Business</span>,
]
...
export const clientResults: ClientResult[] = [
  { client: 'OLX', category: 'E-Commerce', metric: 'Organic Traffic Growth', metricValue: 340, metricSuffix: '%', description: 'Boosted organic visibility through technical SEO and content strategy across 12 regional markets.', color: 'text-primary' },
  { client: 'Glovo', category: 'Food Delivery', metric: 'Revenue Increase', metricValue: 280, metricSuffix: '%', description: 'Rebuilt the delivery partner app and optimized conversion funnels, driving massive revenue gains.', color: 'text-secondary' },
  { client: 'Flutterwave', category: 'Fintech', metric: 'Transaction Speed', metricValue: 95, metricSuffix: '% faster', description: 'Architected a high-performance payment processing pipeline handling millions of daily transactions.', color: 'text-primary' },
