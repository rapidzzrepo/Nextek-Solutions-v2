...
<section class="max-w-container-max mx-auto px-margin-mobile sm:px-margin-tablet md:px-margin-desktop mb-12 md:mb-section-gap">
...
<!-- Category Filter -->
<section class="max-w-container-max mx-auto px-margin-mobile sm:px-margin-tablet md:px-margin-desktop mb-12 md:mb-16">
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">Sovereign Cloud: Migrating 400TB of Sensitive Healthcare Data</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">How we built a fluid design language that adapts to generative output unpredictability.</p>
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">Atlas Robotics: 12ms Latency Control for Industrial Fleets</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">Why enterprise compliance is driving a return to localized, hyper-secure private cloud stacks.</p>
<div class="pt-4 flex items-center gap-3">
<div class="w-8 h-8 rounded-full overflow-hidden bg-surface-variant">
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">NeoBank Scale: Supporting 50k Transactions Per Second</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">Optimization techniques for deploying large models without sacrificing user experience speed.</p>
<div class="pt-4 flex items-center gap-3">
<div class="w-8 h-8 rounded-full overflow-hidden bg-surface-variant">
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">Predictive Health: Deploying MRI Diagnostics at Scale</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">How to hire and retain elite technical talent in a post-geographic labor market.</p>
<div class="pt-4 flex items-center gap-3">
<div class="w-8 h-8 rounded-full overflow-hidden bg-surface-variant">
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">Cognitive Automation: Streamlining 10k Customer Workflows</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">Managing independent deployment cycles across diverse product teams without breaking the UI.</p>
<div class="pt-4 flex items-center gap-3">
<div class="w-8 h-8 rounded-full overflow-hidden bg-surface-variant">
...
<h3 class="font-headline-lg text-[18px] sm:text-headline-lg text-on-surface leading-snug group-hover:text-primary transition-colors">Secure Mesh: Encrypted Drone Communication for High-Risk Zones</h3>
<p class="text-on-surface-variant line-clamp-none sm:line-clamp-2">Training models on decentralized data without ever moving it from the edge device.</p>
<div class="pt-4 flex items-center gap-3">
<div class="w-8 h-8 rounded-full overflow-hidden bg-surface-variant">
...
<section class="w-full bg-inverse-surface py-12 md:py-24 px-margin-mobile sm:px-margin-tablet md:px-margin-desktop">
...
<h2 class="font-headline-xl text-[22px] sm:text-headline-xl text-inverse-on-surface max-w-2xl">Partner with Our Architects</h2>
